...
dataset = r'C:\Users\Administrator\Desktop\szj\paper3\experiments\SPF-GZSL-master\data\AWA1'

sysfea = 'middle_embed_sae'

# 读取mat数据
sysfea_Mat = sio.loadmat(dataset + "/" + sysfea + ".mat")

### 属性
Attribute = sysfea_Mat['middle_embed_sae'].T #选取mat文件中的变量
...
Attribute_all = (Attribute_all-a_min)/(a_max - a_min) #85*50
...
#步骤2∶初始化权重
w_key = np.random.randn(85, 85) #AWA下的参数
w_query = np.random.randn(85, 85)
w_value = np.random.randn(85, 85)
...
np.save(r'C:\Users\Administrator\Desktop\szj\paper3\experiments\SPF-GZSL-master\data\AWA1\middle_embed_am_awa.npy', middle_embed_am)
